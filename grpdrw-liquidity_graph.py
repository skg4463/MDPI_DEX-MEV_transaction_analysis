...
# 3시간 단위로 리샘플링
resampled_add = liquidity_add.resample('72H', on='timestamp').agg({'liquidity_delta': 'sum'})
resampled_remove = liquidity_remove.resample('72H', on='timestamp').agg({'liquidity_delta': 'sum'})
resampled_balance = df.resample('72H', on='timestamp').agg({'pool_balance': 'mean'})
